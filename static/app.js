class Chatbox {
    constructor(){
        ...
        //this.apikey = "pnMbb9htcqdfoN5SfBxZxqzb2Qz2";
        this.apikey = "IXKjpO1i10h2sWqeos1nPhM7W913";
        
        // Change host to ngrok url if running remotely
        this.host = "http://localhost:5000";
        //this.host = "https://93ae-2a02-2c40-200-b001-00-1-1336.eu.ngrok.io/";
    ...
    onSendButton(chatbox, customText = undefined, hidden = false){
        ...
        try{
            ...
            console.log("No textfield currently present.");
        }
